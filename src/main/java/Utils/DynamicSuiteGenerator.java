...
public class DynamicSuiteGenerator {
    public static void GenerateSuite() throws Exception {
        ...
        suite.setName("ICIX Test Suite");
        suite.addListener("icix.Utils.ReportListener");
    ...
    private static List<XmlClass> FilterXmlClasse(String moduleName, List<String> tetsIds) {
        String packageName = "icix.Tests."+moduleName.toLowerCase();
    ...
    private static void writeSuiteToFile(XmlSuite suite) {
        String xmlpath = System.getProperty("user.dir") + File.separator + "src" + File.separator + "test" + File.separator + "resources" + File.separator + "suite-xml-files" + File.separator + "icix-test-suite.xml";
    ...
    private static void writeMultipleSuiteToFile(XmlSuite suite) {
        ...
        String xmlpath = System.getProperty("user.dir") + File.separator + "src" + File.separator + "test" + File.separator + "resources" + File.separator + "dynamic_suites_xml_files" + File.separator + "icix-test-suite-"+count+".xml";
